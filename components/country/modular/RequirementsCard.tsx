        ...
        <div className="rounded-2xl bg-amber-500/10 border border-amber-500/20 p-6 md:p-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
                {data.idp_requirement && (
                    <div>
                        <h4 className="text-sm uppercase tracking-wider text-amber-500/80 mb-1">{dict.country.idp_requirement}</h4>
                        <p className="text-xl font-bold text-white">{data.idp_requirement}</p>
                    </div>
                )}
                {data.rental_and_idp_notes && (
                    <div>
                        <h4 className="text-sm uppercase tracking-wider text-amber-500/80 mb-1">{dict.country.notes}</h4>
